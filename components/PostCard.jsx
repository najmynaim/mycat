        ...
        <div className="p-0 pb-12 mb-8 bg-white rounded-lg shadow-lg lg:p-8">
            <div className="relative mb-6 overflow-hidden shadow-md pb-80">
                <img 
                    ...
                    alt={post.title}
                    className="absolute object-cover object-top w-full rounded-lg shadow-lg h-80"
                />
            </div>
            <h1 className="text-3xl font-semibold text-center transition duration-700 cursor-pointer mb-b hover:text-pink-600 ">
